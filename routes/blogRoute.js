...
router.route('/createBlog').get(catchError(isLoggedIn), catchError(RenderCreateBlog)).post(catchError(isLoggedIn), catchError(upload.single('image')), catchError(PostCreateBlog))
router.route('/updateBlog/:id').get(catchError(isLoggedIn),catchError(RenderEditBlog)).post(catchError(isLoggedIn), catchError(upload.single('image')), catchError(PostEditBlog))
